export const quizData = [
  {
    pergunta:
      '<span class="quiz-question-title">QUESTÃO 1:</span> Qual é o primeiro passo de uma prova usando o Princípio da Indução Matemática?',
    alternativas: [
  ...
  {
    pergunta:
      '<span class="quiz-question-title">QUESTÃO 2:</span> Considerando a faixa da parábola y = x<sup>2</sup> no intervalo [0, 1], qual seria a área do retângulo inscrito degenerado, com sua altura determinada por y em x = 0?',
    alternativas: [
      "A) Área infinita.",
      "B) Área indefinida.",
      "C) Área negativa.",
  ...
  {
    pergunta:
      '<span class="quiz-question-title">QUESTÃO 3:</span> Pelo seu conhecimento em Geometria, se você tem uma faixa de parábola no intervalo de [0, 1] e a divide em duas partes iguais, como você descreveria o polígono retangular que se forma?',
    alternativas: [
  ...
  {
    pergunta:
      '<span class="quiz-question-title">QUESTÃO 4:</span> Dividindo a faixa da parabola y = x<sup>2</sup> determinada pelo intervalo [0, 1] em duas partes iguais, qual seria a medida do comprimento de cada subintervalo?',
    alternativas: [
  ...
  {
    pergunta:
      '<span class="quiz-question-title">QUESTÃO 5:</span> Ao dividir a faixa de [0, 1] em duas partes iguais, para o segundo subintervalo, qual seria a altura do polígono retângular inscrito, considerando o valor de x no ponto inicial desse subintervalo?',
    alternativas: [
      "A) y = 0,25",
      "B) y = 0,5",
      "C) y = 0,75",
  ...
  {
    pergunta:
      '<span class="quiz-question-title">QUESTÃO 6:</span> Considerando a faixa da parábola y = x<sup>2</sup> no intervalo [0, 1] dividida em duas partes iguais, qual é a área total do polígono retangular inscrito nessa faixa? <span class="quiz-question-reminder">LEMBRE-SE: A altura é determinada pelo lado esquerdo de cada subintervalo</span>',
  ...
  {
    pergunta:
      '<span class="quiz-question-title">QUESTÃO 7:</span> No Princípio da Indução Matemática, qual a função principal do Caso Base?',
    alternativas: [
